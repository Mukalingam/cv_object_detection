...
class GUI:
    ...
    def common_config(self, title="Detectify: AI-powered object, face, and fire detection"):  # (Beta version :golf:)
        """
    ...
    def appDescription(self):
        ...
        if self.selectedApp == "Object Detection":
            ...
            st.info(
                "To start using this CV based Application you must first select an option from the sidebar menu other than Empty"
            )
...
class DataManager:
    ...
    def __init__(self, guiParam):
        ...
        self.demo_image_examples = {
            "Family-picture": "./data/family_picture.jpg",
            "Fire": "./data/fire.jpg",
            "Dog": "./data/dog.jpg",
